...
const LoadAssets = async () => {
  const imageAssets = Asset.loadAsync([
    ...
    require('./src/assets/Images/auth/background.jpg'),
    require('./src/assets/Images/auth/banner.png'),
    require('./src/assets/Images/auth/logo.png'),
    require('./src/assets/Images/auth/frame.png'),
  ]);
